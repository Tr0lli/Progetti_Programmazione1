...
public class TestEsame {
	...
	public void testRiunioneVirtualeOK() throws RiunioneNonValidaException {
		RiunioneVirtuale r = new RiunioneVirtuale(2021, 8, 22, 2);
		assertTrue("22/8/2021".equals(r.getData()));
	...
	public void testConfrontoRiunioneVirtuale() throws RiunioneNonValidaException {
		RiunioneVirtuale r = new RiunioneVirtuale(2021, 8, 22, 2);
		RiunioneVirtuale r1 = new RiunioneVirtuale(2021, 8, 22, 3);
		RiunioneVirtuale r2 = new RiunioneVirtuale(2021, 8, 20, 2);
		RiunioneVirtuale r3 = new RiunioneVirtuale(2022, 8, 22, 2);
	...
	public void testRiunioneVirtualeKO() throws RiunioneNonValidaException {
		...
		try {
			RiunioneVirtuale r = new RiunioneVirtuale(2021, 15, 22, 2);
			fail();
		} catch (RiunioneNonValidaException r) {
		}

		try {
			RiunioneVirtuale r = new RiunioneVirtuale(2021, 8, 50, 2);
			fail();
		} catch (RiunioneNonValidaException r) {
		}

		try {
			RiunioneVirtuale r = new RiunioneVirtuale(2021, 8, 22, 0);
			fail();
		} catch (RiunioneNonValidaException r) {
		}
	...
	public void testRiunioneInPresenzaOK() throws RiunioneNonValidaException {
		RiunioneInPresenza r = new RiunioneInPresenza(2021, 8, 22, 2, 1);
		assertTrue("22/8/2021".equals(r.getData()));
	...
	public void testConfrontoRiunioneInPresenza() throws RiunioneNonValidaException {
		RiunioneInPresenza r = new RiunioneInPresenza(2021, 8, 22, 2, 1);
		RiunioneInPresenza r1 = new RiunioneInPresenza(2021, 8, 22, 3, 1);
		RiunioneInPresenza r2 = new RiunioneInPresenza(2021, 8, 20, 2, 1);
		RiunioneInPresenza r3 = new RiunioneInPresenza(2022, 8, 22, 2, 1);
	...
	public void testRiunioneInPresenzaKO() throws RiunioneNonValidaException {
		...
		try {
			RiunioneInPresenza r = new RiunioneInPresenza(2021, 15, 22, 2,1);
			fail();
		} catch (RiunioneNonValidaException r) {
		}

		try {
			RiunioneInPresenza r = new RiunioneInPresenza(2021, 8, 50, 2,1);
			fail();
		} catch (RiunioneNonValidaException r) {
		}

		try {
			RiunioneInPresenza r = new RiunioneInPresenza(2021, 8, 22, 0,1);
			fail();
		} catch (RiunioneNonValidaException r) {
		}

		try {
			RiunioneInPresenza r = new RiunioneInPresenza(2021, 8, 22, 1,0);
			fail();
		} catch (RiunioneNonValidaException r) {
		}
	}
	...
	public void testRiunionitoString() throws RiunioneNonValidaException {
		RiunioneVirtuale r = new RiunioneVirtuale(2021, 8, 22, 12);
		assertTrue(r.toString().indexOf("12")>0);
		RiunioneInPresenza r2 = new RiunioneInPresenza(2021, 8, 22, 10,3);
		assertTrue(r2.toString().indexOf("16")>0);
	}
	
	// TEST ciclo riunioni
	@Test
	public void testCicloRiunioni() throws RiunioneNonValidaException, ClassCastException {
		...
		RiunioneInPresenza r4 = new RiunioneInPresenza(2021, 8, 22, 2, 1);
		RiunioneInPresenza r5 = new RiunioneInPresenza(2021, 8, 22, 3, 1);
		RiunioneInPresenza r6 = new RiunioneInPresenza(2021, 10, 20, 2, 1);
		RiunioneInPresenza r7 = new RiunioneInPresenza(2021, 11, 22, 3, 1);
	...
	public void testCicloRiunioniOrdinamento() throws RiunioneNonValidaException {
		...
		RiunioneVirtuale r1 = new RiunioneVirtuale(2022, 8, 21, 3);
		RiunioneInPresenza r2 = new RiunioneInPresenza(2022, 7, 21, 2, 1);
		RiunioneInPresenza r3 = new RiunioneInPresenza(2021, 7, 21, 3, 1);
		...
		assertTrue(s.indexOf("2021") < s.indexOf("2022"));
