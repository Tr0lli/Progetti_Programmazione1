...
// **********************************    Test su Task
	...
	public void testTaskCreazione1() {
		Task task = new Task("Lavare auto", DataUtil.getDataDiOggi()+1000, 1);
		assertEquals(new String("Lavare auto"), task.getTitolo());
		assertEquals(DataUtil.getDataDiOggi()+1000, task.getData());
	...
	public void testTaskCreazione2() {
		Task task = new Task(null, DataUtil.getDataDiOggi()+1000, 1);
	...
	public void testTaskCreazione3() {
		Task task = new Task("Lavare auto", 20220421, 1);
		assertEquals(new String("Lavare auto"), task.getTitolo());
	...
	public void testTaskCreazione4() {
		Task task = new Task("Lavare auto", DataUtil.getDataDiOggi()+1000, 0);
		assertEquals(new String("Lavare auto"), task.getTitolo());
		assertEquals(DataUtil.getDataDiOggi()+1000, task.getData());
		assertEquals(1, task.getDurata());
		assertFalse(task.isEseguito());
	...
	public void testTaskCreazione5() {
		Task task = new Task("Lavare auto", DataUtil.getDataDiOggi()+1000, 9);
		assertEquals(new String("Lavare auto"), task.getTitolo());
		assertEquals(DataUtil.getDataDiOggi()+1000, task.getData());
		assertEquals(1, task.getDurata());
		assertFalse(task.isEseguito());
...
// **********************************    Test su ToDoList	
	...
	public void testToDoListDurataTaskGiorno1() { 
		...
		todo.aggiungiTask(new Task("Spesa", DataUtil.getDataDiOggi()+1000, 1));
		todo.aggiungiTask(new Task("Yoga", DataUtil.getDataDiOggi()+1000, 2));
		int durata = todo.getDurataTaskGiorno(DataUtil.getDataDiOggi()+1000);
	...
	public void testToDoListPosizioneTask2() { 
		ToDoList todo = new ToDoList(4);
		todo.aggiungiTask(new Task("Spesa", 20220430, 1));
		todo.aggiungiTask(new Task("Yoga", 20220430, 2));
		int posizone = todo.getPosizioneTask(new Task("Lezione", 20220430, 2));
		assertEquals(-1, posizone);		
	}
	...
	public void testToDoListTimuoviTask1() { 
		...
		todo.aggiungiTask(new Task("Spesa", 20220430, 1));
		todo.aggiungiTask("Lezione", 6);
		boolean esito = todo.rimuoviTask(new Task("Spesa", 20220430, 1));
		assertTrue(esito);	
		assertEquals(0, todo.getDurataTaskGiorno(20220430));
	}
	...
	public void testToDoListTimuoviTask2() { 
		...
		todo.aggiungiTask(new Task("Spesa", DataUtil.getDataDiOggi()+1000, 1));
		todo.aggiungiTask("Lezione", 6);
		boolean esito = todo.rimuoviTask(new Task("Yoga", 20220430, 1));
		assertFalse(esito);	
		assertEquals(1, todo.getDurataTaskGiorno(DataUtil.getDataDiOggi()+1000));
	}
}
